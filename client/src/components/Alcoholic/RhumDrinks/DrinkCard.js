...
// let object = state.selValRhum.drinkInfoRhumArray;
// console.log('selectValue', state.selValRhum.selectRhumValue)
// console.log('drinkInfoRhumArray', state.selValRhum.drinkInfoRhumArray)
//
// const object2 = object[0];
//
// if(object !== undefined){
// console.log('rhumObject', object)
// }
//
